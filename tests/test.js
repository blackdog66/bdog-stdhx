...
Test.__name__ = ["Test"];
Test.main = function() {
	haxe.Log.trace(js.Node.process.memoryUsage(),{ fileName : "Test.hx", lineNumber : 6, className : "Test", methodName : "main"});
	haxe.Log.trace(js.Node.process.memoryUsage().heapTotal,{ fileName : "Test.hx", lineNumber : 7, className : "Test", methodName : "main"});
}
...
}
{
	...
	haxe.Log.trace("done init",{ fileName : "Node.hx", lineNumber : 376, className : "js.Node", methodName : "__init__"});
}
js.Node.UTF8 = "utf8";
js.Node.ASCII = "ascii";
